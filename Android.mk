...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.xiaomi.hardware.displayfeature-V1.0-java
LOCAL_MODULE_OWNER := redmi
LOCAL_SRC_FILES := proprietary/framework/vendor.xiaomi.hardware.displayfeature-V1.0-java.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.xiaomi.hardware.displayfeatureqservice-V1.0-java
LOCAL_MODULE_OWNER := redmi
LOCAL_SRC_FILES := proprietary/framework/vendor.xiaomi.hardware.displayfeatureqservice-V1.0-java.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
